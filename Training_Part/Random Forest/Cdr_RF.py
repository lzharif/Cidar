...
# Name
filename_noproc = 'RF_noproc.sav'
filename_pca = 'RF_pca.sav'
filename_lda = 'RF_lda.sav'
filename_kpca = 'RF_kpca.sav'
filename_scale = 'scale.sav'
filename_dr_pca = 'pca.sav'
filename_dr_lda = 'lda.sav'
filename_dr_kpca = 'kpca.sav'
filename_res_noproc = 'RF_res_noproc.txt'
filename_res_pca = 'RF_res_pca.txt'
filename_res_lda = 'RF_res_lda.txt'
filename_res_kpca = 'RF_res_kpca.txt'
...
def cariGrid(clsf, preproc, xtr, ytr, xte, yte, accu, std, test_accu):
    ...
    clsf = RandomForestClassifier(**best_parameters).fit(xtr, ytr)
